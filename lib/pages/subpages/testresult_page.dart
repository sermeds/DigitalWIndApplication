...
class TestResult extends StatelessWidget {
  ...
  addReward(BuildContext context, int xp, int money) {
    AppDataProvider.of(context)!.appData.player!.balance += money;
    AppDataProvider.of(context)!.appData.player!.exp += xp;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: WillPopScope(
          onWillPop: () async {
            addReward(context, calcRemaindReward(rewardMaxXP, percent, test.percent), calcRemaindReward(rewardMaxMoney, percent, test.percent));
